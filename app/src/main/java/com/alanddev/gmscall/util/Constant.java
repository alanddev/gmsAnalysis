...
public class Constant {
    ...
    public static final String PATH_IMG= Environment.getExternalStorageDirectory().getPath()+"/gmscall/image";
    ...
    public static final long SPLASH_DISPLAY_LONG = 1200;
    public static final long SPLASH_DISPLAY_SHORT = 600;
    ...
    public static final int COMMAND_ADD_RESULT = 2;
